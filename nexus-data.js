/* ========================================================
   Bukhari Nexus Pvt Ltd - Master Engine with Flag Matrix
   ======================================================== */
...
const nexusDatabase = {
    modules: {
        ...
        about: { title: "Corporate Mandate", layout: "single", cssFile: "style.css", content: `<div class="standalone-box"><h3>Architecting Global Reliability</h3><p>Bukhari Nexus Pvt Ltd operates as a synchronized parent corporate shell...</p></div>` },
        history: { title: "Our Trajectory", layout: "single", cssFile: "style.css", content: `<div class="standalone-box"><h3>From Asset Development to Diversified Operations</h3></div>` },
        contact: { title: "Global Coordination Desks", layout: "single", cssFile: "style.css", content: `<div class="standalone-box"><h3>Contact Information Loaded</h3></div>` }
    }
};
...
function switchNexusModule(moduleId) {
    ...
    if (typeof triggerMediaInjection === 'function') {
        setTimeout(triggerMediaInjection, 100);
    }
